...
class Modifygroupuserdashboard extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/modify-group-dashboard-edit")
    }
    // end
    render() {
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Card className={classes.card} variant="outlined">
                    ...
                    >
                        <Grid item>
                            <Button className={classes.clear}>Modify User Group</Button>
                        </Grid></Grid>
                </Card>
                {/* end */}
            </Container>
...
Modifygroupuserdashboard.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Modifygroupuserdashboard));