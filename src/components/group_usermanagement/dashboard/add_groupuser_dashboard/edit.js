...
class Addgroupuserdashboardedit extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handlesubmit = () => {
        ...
        // }, 3000);
        this.props.history.push("/add-group-dashboard")
    }
    // end
...
Addgroupuserdashboardedit.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Addgroupuserdashboardedit));