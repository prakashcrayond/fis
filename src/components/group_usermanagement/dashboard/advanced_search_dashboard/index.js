...
class Advancesearchgroupuserdashboard extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/advancesearch-group-dashboard-edit")
    }
    // end
    render() {
...
Advancesearchgroupuserdashboard.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Advancesearchgroupuserdashboard));