...
class ModifyGroupUsermanagementForm extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleSubmit = () => {
        ...
        // }, 3000);
        // this.props.history.push("/succus-user-group-modify")
    }
    // end
    ...
    handleClosesubmit = () => {
        ...
        this.setState({ ...state, open1: !state.open1 }, () => {
            if (state.open1) {
                return this.props.history.push("/succus-user-group-modify")
            }
        })
    }
    // end
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    ...
                    <Typography color="textPrimary" className={classes.title}>Edit</Typography>
                </Breadcrumbs>
                {/* end */}

                {/* card component */}
                <Card className={classes.card} variant="outlined">
                    <CardContent className={classes.card_title}>Edit User Group</CardContent>
                    <Container>
                                    ...
                                    <TableBody>
                                        {hidden && <> <TableRow>
                                            ...
                                            <TableCell className={classes.cell} align="left"> {usermanagements.map(v => {
                                                return <Button onClick={() => this.choosebtn("usermanagement", v, 'checkedA', usermanagements?.length)} variant="contained" className={usermanagement?.length > 0 ? usermanagement.includes(v) ? classes.choosebtnactive : classes.choosebtn : classes.choosebtn}>{v}</Button>
                                            })}
                                                <FormControlLabel
                                                    className={classes.checkboxui}
                                                    control={
...
ModifyGroupUsermanagementForm.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(ModifyGroupUsermanagementForm));