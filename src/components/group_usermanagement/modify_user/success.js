...
const data = {
    bread: [
        "User group Management", "search User","Search Results","Modify User Group", "Success"
    ],
    path: "/modify-group-user-management-table"
}
// style
const styles = (theme) => ({
    root: {
...
class SuccusUserGroupModify extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {};
...
export default withStyles(styles)(withRouter(SuccusUserGroupModify));