...
class AddGroupUsermanagementForm extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handlesubmit = () => {
        ...
        // }, 3000);
        this.props.history.push("/succus-user-group-add")
    }
    // end
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <DialogComponent
                    ...
                    component={
                        <div style={{ margin: "auto", textAlign: "center" }}>
                            ...
                            <Typography variant="subtitle2" className={classes.d_title}>Are you sure, would you like to add this user group?</Typography>
                            <Button
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    ...
                    <Typography color={!edit ? "textPrimary" : ""} className={classes.title}>Add User Group</Typography>
                    {edit && <Typography className={classes.title}>Search Results</Typography>}
                    {edit && <Typography color="textPrimary" className={classes.title}>Edit</Typography>}
                </Breadcrumbs>
                {/* end */}

                {/* card component */}
                <Card className={classes.card} variant="outlined">
                    <CardContent className={classes.card_title}>{!edit ? "Add User group" : "Edit User group"}</CardContent>
                    <Container>
...
AddGroupUsermanagementForm.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(AddGroupUsermanagementForm));