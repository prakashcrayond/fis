...
class GroupUsermanagementTable extends React.Component {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/add-group-user-management-form")
    }
    // end
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    ...
                    <Typography className={classes.title}>Add User Group</Typography>
                ...
                {/* back Button */}
                <Button variant="contained" className={classes.backbtn} onClick={() => this.props.history.push("/add-group-user-management-form")}>
...
GroupUsermanagementTable.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(GroupUsermanagementTable));