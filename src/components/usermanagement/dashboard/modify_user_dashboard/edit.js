...
class AdvancesearchuserdashboardEdit extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    // handle submit funcy
    handlesubmit = () => {
        this.props.history.push("/modify-usermanagement-dashboard")
    }
    // end
...
AdvancesearchuserdashboardEdit.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(AdvancesearchuserdashboardEdit));