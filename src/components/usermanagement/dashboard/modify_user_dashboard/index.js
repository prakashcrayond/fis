...
class Advancesearchuserdashboard extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/modify-usermanagement-dashboard-edit")
    }
    // end
    render() {
            ...
            <Container>
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    <Typography color="textPrimary" className={classes.title}>
                        User Management Dashboard</Typography>
                </Breadcrumbs>
                {/* end */}
                ...
                <Card className={classes.card} variant="outlined">
                    ...
                    >
                        <Grid item>
                            <Button className={classes.clear} >Modify User</Button>
                        </Grid></Grid>
                </Card>
                {/* end */}
            </Container>
...
Advancesearchuserdashboard.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Advancesearchuserdashboard));