...
class Addmodifyuserdashboard extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/advancesearch-usermanagement-dashboard-edit")
    }
    // end
    render() {
...
Addmodifyuserdashboard.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Addmodifyuserdashboard));