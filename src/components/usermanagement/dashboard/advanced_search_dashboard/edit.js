...
class AddmodifyuserdashboardEdit extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    // handle submit funcy
    handlesubmit = () => {
        this.props.history.push("/advancesearch-usermanagement-dashboard")
    }
    // end
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    ...
                    <Typography color={"textPrimary"} className={classes.title}>View User</Typography>
                </Breadcrumbs>
                {/* end */}
                ...
                <Button variant="contained" className={classes.backbtn}
                    onClick={() => this.props.history.push("/advancesearch-usermanagement-dashboard")}
                >
...
AddmodifyuserdashboardEdit.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(AddmodifyuserdashboardEdit));