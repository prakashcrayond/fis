...
class Adduserdashboard extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/add-usermanagement-dashboard-edit")
    }
    // end
    render() {
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Card className={classes.card} variant="outlined">
                    ...
                    >
                        <Grid item>
                            <Button className={classes.clear} >Add User</Button>
                        </Grid></Grid>
                </Card>
                {/* end */}
            </Container>
...
Adduserdashboard.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(Adduserdashboard));