...
class Succus extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {};
    ...
    // }
    onsubmit = () => {
        this.props.history.push(data?.path + `/${window.location.pathname.split("/")[2]}`)
                        ...
                        <Grid container item xs={12} className={classes.mainContent}>
                            <Grid item xs={12} sm={12} className={classes.illustratorGrid}>
                                <Grid item xs={12} className={classes.illustrator}>
                                    ...
                                    <Typography variant="subtitle2" className={classes.d_title}>Great! User has been added successfully.</Typography>
                                    <Button
                                        variant="contained"
                                        color="primary"
                                        disableElevation
...
export default withStyles(styles)(withRouter(Succus));