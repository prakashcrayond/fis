...
const data = {
    bread: [
        "User Management", "Search User", "Search Results", "Modify User", "Success"
    ],
    path: "/modify-usermanagement-table"
}
// style
const styles = (theme) => ({
    root: {
...
class SuccusUserModify extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {};
                        ...
                        <Grid container item xs={12} className={classes.mainContent}>
                            <Grid item xs={12} sm={12} className={classes.illustratorGrid}>
                                <Grid item xs={12} className={classes.illustrator}>
                                    ...
                                    <Typography variant="subtitle2" className={classes.d_title}>Great! User has been modified successfully.</Typography>
                                    <Button
                                        variant="contained"
                                        color="primary"
                                        disableElevation
...
export default withStyles(styles)(withRouter(SuccusUserModify));