...
class CheckerdashboardUser extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/checker-dashboard-user-edit")
    }
    // end
    render() {
...
CheckerdashboardUser.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(CheckerdashboardUser));