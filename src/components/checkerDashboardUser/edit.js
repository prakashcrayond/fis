...
class CheckerdashboardUserEdit extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
    ...
    // handle submit funcy
    handlesubmit = () => {
        this.props.history.push("/checker-dashboard-user")
    }
    // end
        ...
        return <div className={classes.root}>
            <Container>
                ...
                <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />}>
                    <Typography className={classes.title}>Checker Dashboard</Typography>
...
CheckerdashboardUserEdit.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(CheckerdashboardUserEdit));