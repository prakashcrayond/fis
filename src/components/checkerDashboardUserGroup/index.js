...
class CheckerdashboardUserGroup extends React.Component {
    // state
    constructor(props) {
        super(props);
        this.state = {
            ...
            data: [{
                ...
                name: "Grand Tech",
                makerid: "LG123456",
                menu: "User Group Mnagement",
                submenu: "Add User Group",
    ...
    handleedit = (val) => {
        ...
        this.props.history.push("/checker-dashboard-user-grp-edit")
    }
    // end
    render() {
                    ...
                    <Container style={{ border: "2px solid #F4F5F8" }}>
                        <div className={classes.body}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} sm={3}>
                                    <Typography variant='subtitle2' className={classes.text_title}>Menu</Typography>
                                    <Autocomplete
                                        fullWidth={true}
                                        size="small"
                                        // value={area}
                                ...
                                <Grid item xs={12} sm={3}>
                                    <Typography variant='subtitle2' className={classes.text_title}>Sub Menu</Typography>
                                    <Autocomplete
                                        fullWidth={true}
                                        size="small"
                                        // value={area}
...
CheckerdashboardUserGroup.contextType = EdittablesContext;

export default withStyles(styles)(withRouter(CheckerdashboardUserGroup));